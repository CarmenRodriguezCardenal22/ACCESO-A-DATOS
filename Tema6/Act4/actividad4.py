...
if __name__ == "__main__":
    ...
    db_manager = DatabaseManagerDocumental(
        ...
        database_name="1dam",
        collection_name="edificios"
    )
    db_manager.conectar()
    try:
        # Crear documentos dentro de una transacción
        db_manager.iniciar_transaccion()
        db_manager.crear_documento({"nombre": "Louvre", "ubicacion": "Francia", "añoConstruccion": "12/01/1100", "estiloArquitectonico": "Moderno"})
        db_manager.crear_documento({"nombre": "Big Ben", "ubicacion": "Inglaterra", "añoConstruccion": "30/09/1200", "estiloArquitectonico": "Contemporáneo"})
        ...
        db_manager.iniciar_transaccion()
        db_manager.actualizar_documento({"nombre": "Louvre"}, {"añoConstruccion": "01/12/1300"})
        db_manager.confirmar_transaccion()

        # Eliminar un documento
        db_manager.iniciar_transaccion()
        db_manager.eliminar_documento({"nombre": "Big Ben"})
        db_manager.confirmar_transaccion()
